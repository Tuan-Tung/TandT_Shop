  ...
  useEffect(() => {
    ...
    async function renderCart() {
      try {
        ...
        moneySum = moneySum.toLocaleString("vi", {
          style: "currency",
          currency: "VND",
        });
        setCart({
              ...
              <div className="col-xl-9 mr">
                <div className="row pr">
                  <div className="col-xl-6 cart__icon--start">
                    <Link className="name--product" to="/">
                      {value.title}
                    </Link>
                    <p>Sale: {value.sale}%</p>
                    {/* <p>Size: {value.size}</p> */}
                  ...
                  <div className="col-xl-6 cart__icon--end">
                    <div className="cart__quantity">
                      <button
                        type="button"
                        onClick={() =>
                          onMinus(value.qty, value.slug, value.size)
                        }
                        className={
                          !number ? "cart__minus" : "cart__minus disable"
                        }
                        disabled={number}
                      >
                        -
                      ...
                      <button
                        onClick={() =>
                          onPlus(value.qty, value.slug, value.size)
                        }
                        className={
                          !number ? "cart__plus" : "cart__plus disable"
                        }
                        disabled={number}
                      >
                        +
            ...
            <div className="col-xl-8 col-lg-8 mr">
              <div className="cart__content">
                <h2 className="cart__title">
                  Giỏ Hàng ( {cartProduct?.result} sản phẩm )
                </h2>
            ...
            <div className="col-xl-4 col-lg-4 mr cart__sum">
              <div className="cart__total">
                ...
                <div className="cart__amuont">
                  ...
                  <span className="cart__amount--price">
                    {cartProduct.sumProduct}
                  </span>
                </div>
                <div className="cart__amuont">
